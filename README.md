...
Готовые сборки публикуются в разделе **[Releases](https://github.com/LebedevVI/DnDMapHelper/releases)** на GitHub.

1. Откройте последний релиз.
2. Скачайте архив `DnDMapHelper-v*-win-x64.zip`.
3. Распакуйте и запустите `DnDMapHelper.exe`.
...
* включать сетку на экране мастера и задавать масштаб (км на клетку);
* размещать точки интереса;
* связывать их маршрутами и смотреть срок пути и расход пайков;
...
По каждому маршруту можно открыть параметры путешествия: протяжённость в км, срок пути по дороге / пересечённой / труднопроходимой местности и расход еды (пайки) на человека.
